...
def backbone_flexibility(
    traj_info: TrajInfo, top_info: TopInfo, system: System, ncpus=1
...
def cli_parser(prog="backbone_flexibility.py"):
    ...
    parser.add_argument(
        ...
        type=str,
        dest="output",
        help="(optional) The name of the file to write the graph to",
    )
    parser.add_argument(
        "-d",
        "--data",
        ...
        type=str,
        dest="data",
        help="(optional) The name of the file to write the data to",
    )
    parser.add_argument(
        "-q",
        "--quiet",
